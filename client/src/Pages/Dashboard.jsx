      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {showCreateResume && (
          ...
          >
            ...
            >
              <h2 className="tect-xl font-bold mb-4">Create a Resume</h2>
              <input
                onChange={(e) => setTitle(e.target.value)}
                value={title}
                type="text"
                placeholder="Enter resume title"
                className="w-full px-4 py-2 my-2 focus:border-green-600 ring-green-600"
                required
              />
        ...
        {showUploadResume && (
          ...
          >
            <div
              ...
              className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6"
            >
              <h2 className="tect-xl font-bold mb-4">Upload Resume</h2>
              <input
                onChange={(e) => setTitle(e.target.value)}
                value={title}
                type="text"
        ...
        {editResumeId && (
          ...
          >
            <div
              ...
              className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6"
            >
              <h2 className="tect-xl font-bold mb-4">Edit Resume Title</h2>
              <input
                onChange={(e) => setTitle(e.target.value)}
                value={title}
                type="text"
